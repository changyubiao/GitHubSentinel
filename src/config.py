...
class Config:
    ...
    def load_config(self):
        ...
        with open(config_file, "r") as f:
            ...
            # 默认早上8点更新 (操作系统默认时区是 UTC +0，08点刚好对应北京时间凌晨12点) gitbub
            self.exec_time = config.get("github_progress_execution_time", "08:00")
            # 默认每天执行 hackernews 热点报告
            self.hacknews_frequency_days = config.get("hacknews_frequency_days", 1)
            self.hacknews_execution_time = config.get("hacknews_execution_time", "08:00")
